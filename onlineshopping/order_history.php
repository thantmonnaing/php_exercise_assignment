                    ...
                    <div class="col-sm-4 my-3">
                        <div class="card orderCard">
                            ...
                            <div class="card-body">
                                ...
                                <a href="javascript:void(0)" class="btn btn-secondary mainfullbtncolor btn-sm orderDetail" data-id="<?= $id; ?>" data-orderdate="<?= $orderdate ?>" data-voucherno="<?= $voucherno; ?>" data-total="<?= $total; ?>" data-status="<?= $status; ?>" data-toggle="modal" data-target="#detailModal">
                                    Show Detail
                                </a>
